...
#import "XYMNavigationController.h"
#import "XYMAnimation.h"

@interface XYMNavigationController ()<UIGestureRecognizerDelegate,UINavigationControllerDelegate>

@property(strong,nonatomic)UIImageView * screenshotImgView;
@property(strong,nonatomic)UIView * coverView;
@property(strong,nonatomic)NSMutableArray * screenshotImgs;

@property (nonatomic,strong)XYMAnimation *xymAnimation;

@end

@implementation XYMNavigationController

- (XYMAnimation *)xymAnimation
{
    if (_xymAnimation == nil) {
        _xymAnimation = [[XYMAnimation alloc]init];
        
    }
    return _xymAnimation;
}
...
{
    self.xymAnimation.navigationOperation = operation;
    self.xymAnimation.navigationController = self;
    return self.xymAnimation;
}
...
- (NSArray<UIViewController *> *)popToViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    _xymAnimation.removeCount = removeCount;
    return [super popToViewController:viewController animated:animated];
}
- (NSArray<UIViewController *> *)popToRootViewControllerAnimated:(BOOL)animated
{
    [_screenshotImgs removeAllObjects];
    [_xymAnimation removeAllScreenShot];
